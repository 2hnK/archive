...
![사례 1 페이지 단위 처리 생성 결과에서 ‘그것이’를 강조한 화면](./images/ai-textbook-chunking-strategy/case-1-page-based-highlighted.png)

**앞뒤 문단**

![사례 1 앞뒤 문단 참고 생성 결과에서 ‘후추가’를 강조한 화면](./images/ai-textbook-chunking-strategy/case-1-adjacent-context-highlighted.png)

**그리디 청킹**

![사례 1 그리디 청킹 생성 결과에서 ‘후추가’를 강조한 화면](./images/ai-textbook-chunking-strategy/case-1-greedy-chunking-highlighted.png)
...
![사례 2 페이지 단위 처리 생성 결과에서 ‘맞아서 아픈지 아닌지’를 강조한 화면](./images/ai-textbook-chunking-strategy/case-2-page-based-highlighted.png)

**앞뒤 문단**

![사례 2 앞뒤 문단 참고 생성 결과에서 ‘아기가 맞아서 아픈지는’을 강조한 화면](./images/ai-textbook-chunking-strategy/case-2-adjacent-context-highlighted.png)

**그리디 청킹**

![사례 2 그리디 청킹 생성 결과에서 ‘물건에 맞아 아픈지는’을 강조한 화면](./images/ai-textbook-chunking-strategy/case-2-greedy-chunking-highlighted.png)
...
![사례 3 페이지 단위 처리 생성 결과에서 ‘눈물은’을 강조한 화면](./images/ai-textbook-chunking-strategy/case-3-page-based-highlighted.png)

**앞뒤 문단**

![사례 3 앞뒤 문단 참고 생성 결과에서 ‘아기의 눈에는’을 강조한 화면](./images/ai-textbook-chunking-strategy/case-3-adjacent-context-highlighted.png)

**그리디 청킹**

![사례 3 그리디 청킹 생성 결과에서 ‘아기의 눈에는’을 강조한 화면](./images/ai-textbook-chunking-strategy/case-3-greedy-chunking-highlighted.png)
