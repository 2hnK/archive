...
![사례 1 페이지 단위 처리 생성 결과](./images/ai-textbook-chunking-strategy/case-1-page-based-output.png)

**앞뒤 문단**

![사례 1 앞뒤 문단 참고 생성 결과](./images/ai-textbook-chunking-strategy/case-1-adjacent-context-output.png)

**그리디 청킹**

![사례 1 그리디 청킹 생성 결과](./images/ai-textbook-chunking-strategy/case-1-greedy-chunking-output.png)
...
![사례 2 페이지 단위 처리 생성 결과](./images/ai-textbook-chunking-strategy/case-2-page-based-output.png)

**앞뒤 문단**

![사례 2 앞뒤 문단 참고 생성 결과](./images/ai-textbook-chunking-strategy/case-2-adjacent-context-output.png)

**그리디 청킹**

![사례 2 그리디 청킹 생성 결과](./images/ai-textbook-chunking-strategy/case-2-greedy-chunking-output.png)
...
![사례 3 페이지 단위 처리 생성 결과](./images/ai-textbook-chunking-strategy/case-3-page-based-output.png)

**앞뒤 문단**

![사례 3 앞뒤 문단 참고 생성 결과](./images/ai-textbook-chunking-strategy/case-3-adjacent-context-output.png)

**그리디 청킹**

![사례 3 그리디 청킹 생성 결과](./images/ai-textbook-chunking-strategy/case-3-greedy-chunking-output.png)
